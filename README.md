...
```sh
go get -u 'github.com/bem-team/bem-go-sdk@v0.11.0'
```
...
The bem library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
`*bem.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `bem.File(reader io.Reader, filename string, contentType string)`
