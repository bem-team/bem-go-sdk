...
func TestBucketNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Buckets.New(context.TODO(), bem.BucketNewParams{
		Name:        "invoices",
...
func TestBucketGet(t *testing.T) {
	...
	_, err := client.Buckets.Get(context.TODO(), "bucketID")
	if err != nil {
		var apierr *bem.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestBucketUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
...
func TestBucketListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Buckets.List(context.TODO(), bem.BucketListParams{
		EndingBefore:  bem.String("endingBefore"),
		Limit:         bem.Int(0),
		NameSubstring: bem.String("nameSubstring"),
