...
// [EventCollectionProcessing], [EventSend], [EventRender].
//
...
type EventUnion struct {
	...
	// "evaluation", "collection_processing", "send", "render".
	...
	// [EventCollectionProcessingMetadata], [EventSendMetadata], [EventRenderMetadata]
	...
	// This field is from variant [EventRender].
	DocxRenderSeconds float64 `json:"docxRenderSeconds"`
	// This field is from variant [EventRender].
	...
	JSON              struct {
		...
		DocxRenderSeconds     respjson.Field
		OutputDownloadURL     respjson.Field
		ValidationSeconds     respjson.Field
		raw                   string
	} `json:"-"`
}
...
func (EventRender) implEventUnion()               {}
...
func (u EventUnion) AsRender() (v EventRender) {
	apijson.UnmarshalRoot(json.RawMessage(u.JSON.raw), &v)
	return
}
...
type EventRender struct {
	...
	DocxRenderSeconds float64 `json:"docxRenderSeconds" api:"required"`
	// Unique ID generated by bem to identify the event.
	EventID string `json:"eventID" api:"required"`
	// Unique identifier of function that this event is associated with.
	FunctionID string `json:"functionID" api:"required"`
	...
	OutputDownloadURL string `json:"outputDownloadURL" api:"required"`
	// The unique ID you use internally to refer to this data point, propagated from
	// the original function input.
	ReferenceID string `json:"referenceID" api:"required"`
	// Wall-clock seconds spent validating the upstream JSON against the doc-type
	// schema.
	ValidationSeconds float64 `json:"validationSeconds" api:"required"`
	// Unique identifier of workflow call that this event is associated with.
	CallID string `json:"callID"`
	// Timestamp indicating when the event was created.
	CreatedAt time.Time `json:"createdAt" format:"date-time"`
	...
	// The inbound email that triggered this event.
	InboundEmail InboundEmailEvent   `json:"inboundEmail"`
	Metadata     EventRenderMetadata `json:"metadata"`
	// Unique identifier of workflow that this event is associated with.
	WorkflowID string `json:"workflowID"`
	// Name of workflow that this event is associated with.
	WorkflowName string `json:"workflowName"`
...
// Returns the unmodified JSON received from the API
func (r EventRender) RawJSON() string { return r.JSON.raw }
func (r *EventRender) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type EventRenderMetadata struct {
	DurationFunctionToEventSeconds float64 `json:"durationFunctionToEventSeconds"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		DurationFunctionToEventSeconds respjson.Field
...
// Returns the unmodified JSON received from the API
func (r EventRenderMetadata) RawJSON() string { return r.JSON.raw }
func (r *EventRenderMetadata) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
